...
#import "DZCThreeTableViewController.h"
#import "UIImageView+WebCache.h"
#import "DZCHomeTableViewCellTwo.h"
@interface DZCThreeTableViewController ()
{
    NSArray *dataArray;
}
@end

@implementation DZCThreeTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    DZCHomeTableViewCellTwo *cell = [tableView dequeueReusableCellWithIdentifier:@"dzcsupersiecell" forIndexPath:indexPath];
